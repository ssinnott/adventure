...
`node tools/harness.ts [--levels 2,6,10] [--roles soldier,brute] [--under 2] [--map thornmark --level 5] [--stats] [--calibrate --write]`
...
seven an encounter at its level should allow (docs/MONSTERS.md §4.4).
