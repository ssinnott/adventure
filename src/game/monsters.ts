...
export type MonsterSprite =
  ...
  | 'skeleton' | 'bone_knight' | 'ghoul' | 'drowned'
...
export const MONSTERS: Record<string, MonsterDef> = Object.fromEntries([
  ...
  M({ id: 'bandit_archer', name: 'Bandit Archer', plural: 'Bandit Archers', sprite: 'archer', hp: 8, ac: 12, attack: 3, dice: 1, sides: 6, bonus: 0, speed: 11, xp: 35, gold: [3, 10], ranged: true, missile: true, tint: '#6a7a4a', size: 0.9 }),
  ...
  M({ id: 'smuggler_bowman', name: 'Smuggler Bowman', plural: 'Smuggler Bowmen', sprite: 'smuggler_bow', hp: 14, ac: 13, attack: 4, dice: 1, sides: 6, bonus: 1, speed: 12, xp: 75, gold: [5, 15], ranged: true, missile: true, tint: '#3a6a6a', size: 0.9, drops: [{ item: 'shortbow', chance: 0.05 }] }),
  ...
  M({ id: 'drowned', name: 'Drowned Man', plural: 'Drowned Men', sprite: 'drowned', hp: 20, ac: 13, attack: 4, dice: 1, sides: 8, bonus: 0, speed: 9, xp: 100, gold: [0, 8], mindless: true, tint: '#5a8a80', size: 0.85, inflict: { cond: 'diseased', chance: 0.15 } }),
  M({ id: 'ghoul', name: 'Ghoul', plural: 'Ghouls', sprite: 'ghoul', hp: 22, ac: 13, attack: 4, dice: 1, sides: 6, bonus: 2, speed: 9, xp: 95, gold: [0, 6], mindless: true, tint: '#8aa070', size: 0.9, inflict: { cond: 'paralysed', chance: 0.1 } }),
  ...
  M({ id: 'brigand_archer', name: 'Brigand Archer', plural: 'Brigand Archers', sprite: 'brigand_archer', hp: 20, ac: 14, attack: 6, dice: 1, sides: 8, bonus: 1, speed: 12, xp: 150, gold: [6, 20], ranged: true, missile: true, tint: '#5a6a3a', size: 0.9, drops: [{ item: 'crossbow', chance: 0.05 }] }),
