...
export const MONSTERS: Record<string, MonsterDef> = Object.fromEntries([
  ...
  M({ id: 'bandit_archer', name: 'Bandit Archer', plural: 'Bandit Archers', sprite: 'archer', hp: 8, ac: 12, attack: 3, dice: 1, sides: 6, bonus: 0, speed: 11, xp: 20, gold: [3, 10], ranged: true, tint: '#6a7a4a', size: 0.9 }),
