...
export const MONSTERS: Record<string, MonsterDef> = Object.fromEntries([
  ...
  M({ id: 'bog_lurker', name: 'Bog Lurker', plural: 'Bog Lurkers', sprite: 'slime', hp: 18, ac: 11, attack: 2, dice: 1, sides: 6, bonus: 0, speed: 5, xp: 30, gold: [0, 0], mindless: true, tint: '#4a6a4a', size: 0.55, inflict: { cond: 'poisoned', chance: 0.25 } }),
  M({ id: 'drowned', name: 'Drowned Lantern', plural: 'Drowned Lanterns', sprite: 'skeleton', hp: 16, ac: 13, attack: 3, dice: 1, sides: 8, bonus: 1, speed: 9, xp: 38, gold: [2, 10], mindless: true, tint: '#7a9aa8', size: 0.9, drops: [{ item: 'potion_sp', chance: 0.1 }] }),
  M({ id: 'ashen_adept', name: 'Ashen Adept', plural: 'Ashen Adepts', sprite: 'cultist', hp: 14, ac: 13, attack: 4, dice: 1, sides: 6, bonus: 1, speed: 11, xp: 44, ranged: true, gold: [8, 24], tint: '#6a4a7a', size: 0.9, drops: [{ item: 'potion_sp', chance: 0.2 }] }),
  M({ id: 'hollow_prior', name: 'The Hollow Prior', plural: 'Hollow Priors', sprite: 'cultist', hp: 68, ac: 16, attack: 6, dice: 2, sides: 6, bonus: 3, speed: 11, xp: 200, gold: [40, 80], tint: '#9a3a5a', size: 1.0, inflict: { cond: 'asleep', chance: 0.2 }, drops: [{ item: 'potion_sp', chance: 1 }] }),
