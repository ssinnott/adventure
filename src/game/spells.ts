// Spell definitions. Four per caster class for the slice, one per spell tier the promotions will
// later unlock. `list` is who can learn it; `sp` the cost; the effect fields say what it does.
...
export const SPELLS: Record<string, SpellDef> = Object.fromEntries(([
  ...
  { id: 'smite', name: 'Smite', list: 'cleric', level: 4, sp: 5, target: 'enemy', context: 'combat', dice: 2, sides: 6, text: 'Holy force strikes one foe.' },
